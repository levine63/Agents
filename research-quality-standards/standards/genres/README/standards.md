...
- lockfiles used by the project, where a lockfile records exact dependency versions for reproducibility
...
Broken or misleading README links, whether relative or external, should be treated the same way when they affect onboarding or reproducibility.
